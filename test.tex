...
\begin{align}
    ...
    & \ \ + \left(\pdv{B_y}{x} dx  + \pdv{B_y}{t} dt \right) \wedge dz \wedge dx 
     + \left( \pdv{B_z}{z} dz + \pdv{B_z}{t} dt\right) \wedge dx \wedge dy\\
    &=\left(\pdv{B_z}{t}-\pdv{E_x}{y}+\pdv{E_y}{x}\right) dt\wedge dx\wedge dy+\left(\pdv{B_y}{t}+\pdv{E_x}{z}-\pdv{E_z}{x}\right) dt\wedge dz \wedge dx +\left(\pdv{E_y}{z}-\pdv{E_z}{y}\right) dz
\end{align}
